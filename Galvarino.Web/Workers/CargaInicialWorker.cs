        ...
        private void DoWork(object state)
        {
            ...
            using (var connection = new SqlConnection(_configuration.GetConnectionString("DocumentManagementConnection")))
            {
                ...
                if (horaActual >= horaInicial && horaActual <= horaFinal && !estaOcupado)
                {
                    ...
                    rutaDescargar = @"c:\cargainicial\Carga180220200.txt";
                    nombreArchivo = "Carga180220200";
                    ...
                    if (existeCarga == 0)
                    {
                        ...
                        if (!estaOcupado)
                        {
                            ...
                            sql = "select Estado from " + Schema + ".CargasInicialesEstado" +
                            " where convert(varchar, fechaCarga,112)= convert(varchar, getdate(), 112)" +
                            " and NombreArchivoCarga = '" + nombreArchivo + "'";
                            estadoCarga = connection.Query<string>(sql).FirstOrDefault();
                           ...
                           " and NombreArchivoCarga = '" + nombreArchivo + "'";
                            ...
                            if (estadoCarga == "CargaArchivoOK")
                            {
                               ...
                               " where NombreArchivoCarga = '" + nombreArchivo + "'";
                                ...
                                UpdateCargasInincialesEstado = @"
                                                   Update  CargasInicialesEstado
                                                   set Estado='CargadoCreditosOK'  
                                                   where NombreArchivoCarga='" + nombreArchivo + "'";
                         ...
                         " and NombreArchivoCarga = '" + nombreArchivo + "'";
                            ...
                            if (estadoCarga == "CargadoCreditosOK")
                            {
                                ...
                                foreach (var ci in configur)
                                {
                                    ...
                                    if (existecredito == null)
                                    {
                                        ...
                                        string insertar = " insert into ExpedientesComplementarios(CreditoId,folioCredito,numeroticket)" +
                                        ...
                                        foreach (var confItem in configs)
                                        {
                                            ...
                                            if (confItem.Codificacion == "05") //Codigicacion aval opcional
                                            {
                                                if (ci.CodigoOficinaIngreso != ci.CodigoOficinaPago)
                                                {
                                                    if (ci.Aval == "1")
                                            ...
                                            else if (confItem.Codificacion != "00" && confItem.Codificacion != "10" && confItem.Codificacion != "05") //se cargan todos los documentos
                                            {
                                                if (ci.CodigoOficinaIngreso == ci.CodigoOficinaPago)
                                                {
