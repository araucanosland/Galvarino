        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                using (var _context = _scope.ServiceProvider.GetRequiredService<ApplicationDbContext>())
                {
                    ...
                    /*_context.ConfiguracionDocumentos.Add(new ConfiguracionDocumento{ TipoDocumento = TipoDocumento.Pagare, TipoExpediente = TipoExpediente.Legal, TipoCredito=TipoCredito.Normal });
                    _context.ConfiguracionDocumentos.Add(new ConfiguracionDocumento { TipoDocumento = TipoDocumento.SolicitudCredito, TipoExpediente = TipoExpediente.Legal, TipoCredito = TipoCredito.Normal });
                    _context.ConfiguracionDocumentos.Add(new ConfiguracionDocumento { TipoDocumento = TipoDocumento.FotocopiaCedulaIdentidad, TipoExpediente = TipoExpediente.Legal, TipoCredito = TipoCredito.Normal });
                    ...
                    {
                        _logger.LogDebug("Cargando Archivo a la BD......");
                        int lap = 0;
