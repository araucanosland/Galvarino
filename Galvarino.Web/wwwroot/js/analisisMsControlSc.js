...
const metodos = {
    ...
    avanzarWf: function () {
        ...
        $.ajax({
            type: "POST",
            url: `/api/wfSc/v1/analisis-mesa-control-sc`,
...
function formatoReparoSetComercial(val, row, inc) {

    row.reparo = 0;
    let salida = `<select class="form-control reparo" id="${inc}">`;
    salida = salida + opcionesReparosSetComplementario.map(function (val, index) {
