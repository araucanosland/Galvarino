const metodos = {
    ...
    avanzarWf: function (codigoCaja) {
        ...
        $.ajax({
            type: "GET",
            url: `/api/wfSc/v1/despacho-a-custodia-sc/${codigoCaja}`,
    ...
    pistoleo: function (codigoCaja, folioDocumento) {
        ...
        $.ajax({
            type: "GET",
            url: `/api/wfSc/v1/despacho-a-custodia-sc/caja-valorada/${codigoCaja}/agregar-documento/${folioDocumento}`,
            contentType: "application/json; charset=utf-8"
        }).done(function (data) {
            console.log({
                data
    ...
    generarCaja: function () {
        ...
        $.ajax({
            type: "GET",
            url: `/api/wfSc/v1/despacho-a-custodia-sc/generar-caja-valorada/${skp}`,
            contentType: "application/json; charset=utf-8"
        }).done(function (data) {
            console.log(data);
    ...
    obtenerCaja: function () {
        ...
        $.ajax({
            type: "GET",
            url: `/api/wfSc/v1/despacho-a-custodia-sc/generar-caja-valorada`,
            contentType: "application/json; charset=utf-8"
        }).done(function (data) {
            console.log(data);
            $('.titulo-genera-cajas').text(`Generando Caja Folio: ${data.caja.codigoSeguimiento}`);
    ...
    chequearCaja: function () {
        ...
        $.ajax({
            type: "GET",
            url: `/api/wfSc/v1/despacho-a-custodia-sc/chequear-caja-valorada`,
            contentType: "application/json; charset=utf-8"
        }).done(function (data) {
            console.log(data);
            debugger;
